          ...
          <div className="relative card-surface rounded-2xl overflow-hidden border border-white/8 shadow-[0_40px_100px_rgba(0,0,0,0.8)]">
            ...
            <div className="grid grid-cols-4 min-h-[380px]">
              ...
              <div className="col-span-1 border-r border-white/5 bg-bg-secondary/40 p-4 space-y-1 hidden md:block">
                {["Overview", "Deployments", "Templates", "Workspaces", "Sync", "Settings"].map((item, i) => (
                  <div
                    key={item}
              ...
              <div className="col-span-4 md:col-span-3 p-6 space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm font-semibold text-text-primary mb-1">Workspace Overview</div>
                    <div className="text-xs text-text-muted">3 active deployments · Last sync 2m ago</div>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div key={stat.label} className="p-3 rounded-xl bg-bg-card border border-white/5">
                      <div className="text-lg font-display font-700 text-text-primary">{stat.value}</div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={row.name} className="flex items-center justify-between p-3 rounded-xl bg-bg-card/60 border border-white/4">
                      <div className="flex items-center gap-3">
                        <div className={`w-2 h-2 rounded-full ${row.status === "live" ? "bg-success" : "bg-warning animate-pulse"}`} />
                        <span className="text-xs font-medium text-text-secondary">{row.name}</span>
                      </div>
                      <div className="flex items-center gap-3">
